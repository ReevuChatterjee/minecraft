...
public class Camera {
    ...
    private boolean collisionEnabled = false; // Toggle with a key
    
    public Camera(int width, int height) {
        position = new Vector3f(0, 80, 0);
    ...
    public void toggleCollision() {
        ...
        System.out.println("Collision: " + (collisionEnabled ? "ON" : "OFF"));
    }
